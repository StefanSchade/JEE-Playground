 ...
 The application will be running at the following URL:
  ...
  http://localhost:7070/002_JSF_WELD_ARCH
...
<settings
 ...
 Start JBoss AS. The application will be running at the following URL:
  ...
  http://localhost:8080/002_JSF_WELD_ARCH

 If you want to deploy to GlassFish (standalone), you can upload the
 target/002_JSF_WELD_ARCH.war archive using the web-based administration console.
